...
const articles: Article[] = [
  {
    id: "7",
    slug: "chapygina-4-petrogradskaya-storona-lokaciya",
    title: "Чапыгина, 4 на Петроградской стороне: почему это идеальная локация для клубного дома премиум-класса",
    excerpt:
      "Петроградская сторона — один из самых престижных районов Санкт-Петербурга с богатой историей, развитой инфраструктурой и уникальной архитектурой. Клубный дом «Коллекционер» на улице Чапыгина, 4 расположен в самом сердце этого района, предлагая жителям идеальное сочетание центрального расположения, культурного наследия и современного комфорта.",
    date: "2025-10-01",
    readTime: "15 мин",
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_1078-QZv6kuOzVbI7WOSHQu1COdEv63NcDy.webp",
  },
  {
    id: "6",
