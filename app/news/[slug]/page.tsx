...
const articles: Article[] = [
  {
    ...
    content: `
      ...
      <ul>
        ...
        <li><strong>Статус</strong>: гранитные фасады — признак премиального жилья</li>
      </ul>
      ...
      <ul>
        <li>Увеличивают площадь квартир на верхних этажах</li>
      ...
      <ul>
        ...
        <li>Гармонично вписывается в сложившуюся застройку Петроградской стороны</li>
      </ul>
      ...
      <ul>
        ...
        <li>✅ Приватный двор-патио в испанском стиле</li>
        <li>✅ Квартиры со вторым светом до 6,4 м</li>
      </ul>
      ...
      <ul>
        ...
        <li>✅ Арт-концепция с пинакотекой</li>
        <li>✅ Локация на Петроградской стороне (более престижная)</li>
      </ul>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Пинакотека, латунь</td>
            <td>Угловая башня</td>
            <td>Шесть секций</td>
          </tr>
          <tr>
            <td>Двор</td>
            <td>Закрытый патио</td>
      ...
      <p><strong>Петроградская сторона — заповедник петербургской архитектуры</strong>, где сосредоточены здания модерна, неоклассицизма и эклектики начала XX века. <strong>Эклектичный «Коллекционер» органично вписывается в этот контекст</strong>, не подражая напрямую историческим образцам, но <strong>создавая с ними диалог</strong>.</p>
      ...
      <strong>Натуральные материалы и обильный декор</strong> — визуальные маркеры премиального жилья. Прохожий мгновенно считывает статус здания.</p>
      ...
      <ul>
        ...
        <li>✅ «Коллекционер» — эталон неоэклектики для Петроградской стороны</li>
      </ul>
      ...
      <p><em>Читайте также: <a href="/news/zastroishchik-razreshenie-kollekcioner">Застройщик получил разрешение на строительство</a></em></p>
    `,
    date: "2025-09-30",
    readTime: "12 мин",
  ...
  },
  {
    ...
    content: `
      ...
      <p>Хочется увидеть, как пинакотека работает в реальном пространстве? <a href="/#contact">Закажите презентацию</a> и подбор планировок: на старте продаж действует приоритетная запись на показы и спецусловия.</p>
